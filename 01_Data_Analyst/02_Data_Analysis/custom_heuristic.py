...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        elif passenger['Sex'] == 'female' and passenger['Pclass'] == 3 and passenger['Age'] < 27:
            predictions[passenger_id] = 1
            counts += 1
        ...
        elif passenger['Age'] < 37 and passenger['Pclass'] == 1:
            predictions[passenger_id] = 1
            counts += 1
        ...
        elif passenger['Age'] < 1 and passenger['Pclass'] == 3:
            predictions[passenger_id] = 1
            counts += 1

            #print passenger[['PassengerId','Survived','Pclass','Sex','Age']]
            #print '\n\n'
