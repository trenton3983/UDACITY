...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        if (passenger['Sex'] == 'female' and passenger['Pclass'] == 1) or \
           ...
           (passenger['Sex'] == 'female' and passenger['Pclass'] == 3 and passenger['Age'] < 28) or \
           (passenger['Age'] < 16 and passenger['Pclass'] == 2) or \
           (passenger['Age'] < 37 and passenger['Pclass'] == 1) or \
           (passenger['Parch'] > 5) or (passenger['Age'] < 1 and passenger['Pclass'] == 3):
